...
class sabQueuePresenter_Test(BaseTestCase.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.test_presenter = sabQueuePresenter(window=Mock(spec=cursesWindow),
    ...
    def test_displayFileInformation_should_add_pad_instructions(self):
        ...
        assert len(self.test_presenter.pad) == 12
    ...
    def test_displayFileInformation_should_highlight_filename(self):
        ...
        assert self.test_presenter.pad[2][1] == 2
    ...
    def test_displayFileInformation_should_highlight_priority(self):
        ...
        assert self.test_presenter.pad[6][1] == 2
    ...
    def test_displayFileInformation_should_highlight_unpack_settings(self):
        ...
        assert self.test_presenter.pad[8][1] == 2
    ...
    def test_wait_should_call_window_wait(self):
        self.test_presenter.window.size = ["1", "1"]

        self.test_presenter.wait(100)

        self.test_presenter.window.wait.assert_called_with(100)
